...
use crate::{
    kzg10::Proof,
    sonic_pc::{proof::ProofVar, SonicKZG10},
    BatchLCProof,
    Vec,
};
...
impl<TargetCurve, BaseCurve, PG>
    AllocGadget<
        BatchLCProof<<TargetCurve as PairingEngine>::Fr, <TargetCurve as PairingEngine>::Fq, SonicKZG10<TargetCurve>>,
...
mod tests {
    ...
    use crate::{sonic_pc::SonicKZG10, LabeledPolynomial, LinearCombination, PolynomialCommitment, QuerySet};
